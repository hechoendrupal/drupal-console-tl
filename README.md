# drupal-console-tl
DrupalConsole Tagalog Language / Tagalog wika
...
```
$ composer require drupal/console-tl
```
...
- Fork this repository following this link [https://github.com/hechoendrupal/drupal-console-tl#fork-destination-box](https://github.com/hechoendrupal/drupal-console-tl#fork-destination-box)
...
```
$ git remote add upstream git@github.com:hechoendrupal/drupal-console-tl.git
```
